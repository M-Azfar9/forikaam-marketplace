      ...
      <footer className="py-16 px-6 border-t border-slate-900 bg-slate-950/40 relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 mb-12 text-left">
          ...
          <div className="md:col-span-5 flex flex-col items-start">
            ...
            <span className="text-xs text-slate-500 block">hello@forikaam.pk</span>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col items-start md:items-end">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-emerald-400 hover:border-emerald-500/30 transition-all" aria-label="LinkedIn">
                LN
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-emerald-400 hover:border-emerald-500/30 transition-all" aria-label="WhatsApp">
                WA
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-emerald-400 hover:border-emerald-500/30 transition-all" aria-label="Twitter">
                X
              </a>
            </div>
          </div>
        ...
        {/* Legal Footer SECP */}
        <div className={`max-w-7xl mx-auto pt-8 border-t border-slate-900 text-center flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 ${isUrdu ? "sm:flex-row-reverse" : ""}`}>
          <span>{t.footCopyright}</span>
          <span className="text-emerald-400 font-mono">{t.footNadraPartner}</span>
        </div>
      </footer>
    </div>
  );
